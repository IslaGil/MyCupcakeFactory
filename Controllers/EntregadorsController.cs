...
namespace MyCupcakeFactory.Controllers
{
    public class EntregadorsController : Controller
    {
        ...
        public EntregadorsController(MyCupcakeFactoryContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Entregador.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome")] Entregador entregador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome")] Entregador entregador)
        {
            if (id != entregador.Id)
            {
                return NotFound();
        ...
        {
            return _context.Entregador.Any(e => e.Id == id);
        }
    }
}
